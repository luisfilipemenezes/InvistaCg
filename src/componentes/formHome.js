    ...
    <motion.div    
        ...
        class="h-screen flex">
            ...
            <div 
                ...
                class="flex w-full lg:w-1/2 justify-center  bg-black items-center  space-y-8">
                <div class="w-full justify-end flex md:mx-12  mx-6">
                <form 
                        ref={form}
           
                        className="bg-white rounded-md shadow-2xl md:p-20 p-8"
                    >
                        <h1 className="text-gray-800 font-bold md:text-4xl text-3xl mb-1">COMPARTILHE SUA OPNIÃO</h1>
                        <p className="text-sm font-normal text-gray-600 mb-8">Sua sugestão é muito importante!</p>
                        ...
                        <button 
                            type="submit" 
                            className="block w-full bg-black mt-5 py-2 rounded-2xl hover:bg-yellow-500 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2"
                        >
                            Enviar
                        </button>
