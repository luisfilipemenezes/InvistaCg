export default function CardComponentHome (){
    return (
        <div>
            <div class="min-h-screen bg-gray-800 flex justify-center items-center py-20 mt-12">
            <div class="container mx-auto p-12 bg-gray-100 rounded-xl">
                ...
                <div class="bg-white  " >
                    ...
                    <div class="shadow-lg hover:shadow-xl transform transition duration-500 hover:scale-105 arredondado-lg">
                        <div>
                        <img class="w-full" src="https://images.unsplash.com/photo-1515344905723-babc01aac23d?auto=format&fit=crop&q=80&w=2076&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                        <div class="px-4 py-2">
                            ...
                            <button class="mt-12 w-full text-center hover:bg-yellow-500 py-2 rounded-lg text-white bg-gray-800">Leia Mais!</button>
                        </div>
                        </div>
                    </div>
                    </div>
                ...
                <div class="bg-white">
                    ...
                    <div class="shadow-lg hover:shadow-xl transform transition duration-500 hover:scale-105">
                        ...
                        <div class="px-4 py-2">
                            ...
                            <p class="text-sm tracking-normal">Częstochowski pomnik Jana Pawła II wyjątkowo interesująco wpisuje się w poprzemysłowy krajobraz tego miasta o mocnych lewicowych, robotniczych i socjalistycznych tradycjach. Powstały w 2013 roku, uchodzi za najwyższego Karola Wojtyłę w Polsce.</p>
                            <button class="mt-12 w-full hover:bg-yellow-500 text-center text-white bg-gray-800 py-2 rounded-lg">Leia Mais!</button>
                        </div>
                        </div>
                    </div>
                    </div>
                ...
                <div class="bg-white">
                    ...
                    <div class="shadow-lg hover:shadow-xl transform transition duration-500 hover:scale-105">
                        ...
                        <div class="px-4 py-2">
                            ...
                            <p class="text-sm tracking-normal">Częstochowski pomnik Jana Pawła II wyjątkowo interesująco wpisuje się w poprzemysłowy krajobraz tego miasta o mocnych lewicowych, robotniczych i socjalistycznych tradycjach. Powstały w 2013 roku, uchodzi za najwyższego Karola Wojtyłę w Polsce.</p>
                            <button class="mt-12 w-full text-center hover:bg-yellow-500 text-white bg-gray-800 py-2 rounded-lg">Leia Mais!</button>
                        </div>
                        </div>
                    </div>
                    </div>
