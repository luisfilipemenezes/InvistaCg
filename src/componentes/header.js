...
const navigation = [
  { name: 'Comércio', href: '../', current: true, icon: FaStore },
  { name: 'Indústria', href: '', current: false, icon: FaIndustry },
  { name: 'Educação', href: '#', current: false, icon: FaBook },
  { name: 'Turismo', href: 'https://saude.campinagrande.pb.gov.br/', current: false, icon: FaPlane },
  { name: 'Notícias', href: 'https://saude.campinagrande.pb.gov.br/', current: false, icon: FaNewspaper }
];
          ...
          <div className="mx-auto sm:mx-12  mx-0 px-2 sm:px-6 lg:px-8 ">
            <div className="relative flex h-16 items-center justify-between ">
              ...
              <div className="flex  flex-1 items-center justify-end sm:items-stretch  sm:justify-start " >
                <div className="flex flex-shrink-0 items-center  lg:mr-10 mr-2">
                  <img
